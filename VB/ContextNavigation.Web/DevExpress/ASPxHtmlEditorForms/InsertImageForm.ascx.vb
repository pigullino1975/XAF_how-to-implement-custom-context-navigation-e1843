...
Partial Public Class InsertImageForm
    ...
    Protected Overrides Sub PrepareChildControls()
        ...
        uplImage.UploadMode = CType(IIf(HtmlEditor.SettingsImageUpload.UseAdvancedUploadMode, UploadControlUploadMode.Advanced, UploadControlUploadMode.Standard), UploadControlUploadMode)
        Localize()
